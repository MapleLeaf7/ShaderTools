...
void BlurTextureFilter::blurInput(void* input, void* output, CCTexture2DPixelFormat format, int width, int height, CCSize contentSize, int radius, CCRect rect)
{
...
CCTexture2DMutable* BlurTextureFilter::blur(CCTexture2DMutable* texture, int radius) 
{
    return this->blur(texture, radius, CCRectZero);
}

CCTexture2DMutable* BlurTextureFilter::blur(CCTexture2DMutable* texture, int radius, CCRect rect) 
{
    if(!texture)
        return NULL;
